...
class PingPongEnvV0(BaseV0):
  DEFAULT_OBS_KEYS = ['pelvis_pos', 'body_qpos', 'body_qvel', 'ball_pos', 'ball_vel', 'paddle_pos', "paddle_vel",
                      'paddle_ori', 'reach_err', "touching_info"]
...
if __name__ == '__main__':
  pingpong_env = PingPongEnvV0((epath.resource_path("myosuite")
                                / "envs/myo/assets/arm/myoarm_tabletennis.xml").as_posix())
